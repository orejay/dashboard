const Data = [
  ...
  },
  {
    ...
    content: [
      "Use the expert’s confidence level to set your staking plans. For Example, Bordeaux vs Marseille (X) @ 3.10 odds. Expert Confidence: 65%. If I were looking for 3odds, I’d rather avoid that fixture due to the high risk in the prediction market and accumulate other matches with 85% Confidence Level till I get my 3 Odds.",

      "For accumulators, you are advised not to accumulate all into one ticket; if you are doing so, then don't stake too high. See Accumlators in Tips Store.",

      "For Sure 2/3 ODDS category. When you get 2 sets of SURE 2/3 ODDS, you are advised to split your budget across the given sets of game.",

      "For Example, Set 1. Real Madrid vs Getafe (HOME WIN). There are days when unforeseen upsets occur in football. Let's say it was one of those days where Getafe goes ahead to beat Madrid... Instead of feeling bad about how much stake you lost. You have a backup set- Set 2 to make up for it. It is very rare for both sets to get foiled. In Summary, if you have a $100 to stake for the Sure 2/3 odds. We advise you split your budget 60:40 across both sets.",
    ],
  },
    {
        title: "When should you bet?",
        content: [
            "At the risk of stating the obvious, you bet when you believe the odds being offered are too high, or let me put it in another way, you think an event is more likely than the bookies are implying in their odds. Another way of saying this is you should bet when the expected value of the bet based on the probability forecast is greater than 1.",

            'For Example: Barcelona vs Levante @1.03 odds for Home Win. I have seen some punters make the mistake of including this in their games "just to boost their returned income" This is absolutely wrong! $1000 x 1.03 odds will still give you $1000.3 #ValuelessBet!',
        ],
    },{
    title: "How much should you bet?",
    content: [
      "There are many different systems for determining the size of your bets and each system has a different risk/return profile. Some of the key characteristics to look at are:",

      <div>
        <p className="my-2">- The risk of going bust;</p>{" "}
        <p className="my-2">- The risk of losing money;</p>{" "}
        <p className="my-2">
  ...
  },
  {
    ...
    content: [
      ...
      <div>
        ...
        <p className="my-2">
          - Bet size shouldn’t depend on arbitrary factors such as what happened
          with your last bet – play each bet on its merits.
        </p>{" "}
        <p className="my-2">- Maximize returns, subject to managing risk.</p>
        <p className="my-2">
          - You don’t want volatility of your betting book to be too great.
        </p>
      </div>,
    ],
  },
