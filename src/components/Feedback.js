...
function Feedback() {
    ...
    return (
      ...
      >
        <div className="flex flex-col justify-between h-full">
          <div className="">
            <div
              className="flex justify-start text-2xl lg:text-4xl font-medium mx-auto millik"
              style={{ maxWidth: "95%" }}
            >
              "
            </div>
            ...
            <div
              className="flex justify-end text-2xl lg:text-4xl font-medium mx-auto millik"
              style={{ maxWidth: "95%" }}
            >
              "
            </div>
  ...
  return (
    ...
    >
      <h2 className="text-xl md:text-2xl lg:text-4xl font-medium millik mb-5 lg:mb-8">
        Punters Feedback
      </h2>
