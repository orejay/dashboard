  ...
  return (
    <div className="mb-10 bg-white">
      <div className="md:w-11/12 flex md:items-center items-start justify-between mx-auto mt-7 md:my-8 mobil">
        <h2 className="md:text-2xl lg:text-3xl font-medium mona-head flex-wrap">
        ...
        {data?.bookie ? (
          <div className="flex flex-col items-center md:items-start w-full md:w-5/12 lg:w-3/12 md:mr-8 mb-2">
            ...
            <div className="flex items-center justify-center w-6/12 md:w-9/12 mt-1 md:mt-2 h-9">
              <div className="text-xs md:text-base font-light mona-head text-white bg-gradient-to-r from-teal-500 to-blue-600 h-full rounded-l-md flex items-center justify-center w-1/2">
                <p>Bet tips on</p>
              </div>
              <a
                href={data?.link}
