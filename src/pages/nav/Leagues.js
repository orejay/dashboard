  ...
  const leagues = (
    <div className="w-full pb-5 lg:pb-16 " style={{ background: "#F2F2F2" }}>
      <div className="lg:py-20 py-14 mb-5 md:mb-16 text-white mx-auto text-center bg-gradient-to-r from-teal-500 to-blue-600">
        <h1 className="lg:text-4xl text-xl millik mx-auto">Leagues</h1>
      </div>
      <div className="py-5 lg:py-10  px-5 lg:px-14 mx-auto rounded-lg md:shadow-md shadow-slate-300 md:bg-white w-full h-screen overflow-y-scroll lg:w-5/6">
        {Object.entries(leaguesData)
          ...
          .map(([name, val], index) => (
            <div key={index}>
              <h1
                className="my-5 font-bold millik hover:text-transparent cursor-pointer hover:bg-clip-text hover:bg-gradient-to-r hover:from-teal-500 hover:to-blue-600 w-fit"
                style={{ fontSize: "20px" }}
              >
                {name}
              </h1>
        ...
        {Object.entries(leaguesData)
          ...
          .map(([name, val], index) => (
            <div key={index}>
              <h1
                className="my-5 font-bold millik hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-teal-500 hover:to-blue-600 w-fit cursor-pointer"
                style={{ fontSize: "20px" }}
              >
                {name}
              </h1>
